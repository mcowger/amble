    ...
    <div className="relative">
      ...
      {isOpen && (
        <>
          ...
          <div className="absolute left-0 bottom-full mb-1.5 w-48 rounded-xl bg-card border border-border shadow-2xl p-1.5 z-50 text-card-foreground">
              ...
              {options.map((opt) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full flex items-center justify-between px-2.5 py-2 rounded-lg text-xs cursor-pointer text-left transition-colors ${
                      isSelected
